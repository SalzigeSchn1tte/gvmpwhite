<template>
    <v-ons-page>
        ...
        <v-ons-bottom-toolbar style="          background-color: #303030 !important;
          background: #303030 !important;">
            <button style="margin-left: 0.6vh; vertical-align: middle; color: orange" class="selectemoji far fa-grin fa-1x" v-on:click="showemoji"><v-ons-icon icon="" class="list-item__icon"></v-ons-icon></button>
            ...
            <button style="vertical-align: middle; color: orange;" class="selectemoji fas fa-map-marker-alt fa-1x" v-on:click="sendGPS"><v-ons-icon icon="md-map-marker" class="list-item__icon"></v-ons-icon></button>
            <button style="vertical-align: middle; color: orange;" class="selectemoji far fa-address-book fa-1x" v-on:click="sendContact(msgPartnerNumber)"><v-ons-icon icon="md-address-book" class="list-item__icon"></v-ons-icon></button>
            <button style="vertical-align: middle; color: orange;" v-on:click="sendMessage"><v-ons-icon icon="md-mail-send" class="list-item__icon"></v-ons-icon></button>
