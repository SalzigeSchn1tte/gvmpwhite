<template>
    <v-ons-page>
        <v-ons-toolbar>
            ...
            <div class="center" style="margin-left: -20px">Messenges</div>
        </v-ons-toolbar>
        <v-ons-list>
            <v-ons-list-item v-if="messages.length == 0">
                <div class="center">Keine SMS vorhanden</div>
            </v-ons-list-item>
        ...
        <v-ons-fab modifier="mini" position='bottom right' style="background-color: orange;">
            <v-ons-icon icon="md-plus" v-on:click="addMessage" style="color: white;"></v-ons-icon>
        </v-ons-fab>
    </v-ons-page>
</template>
