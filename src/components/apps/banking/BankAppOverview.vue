<template>
    <v-ons-page>
        ...
        <v-ons-list>
            <v-ons-list-header>Konto Guthaben: <span style="font-size:1.4vh;color:green;font-weight:bold">${{convert(balance)}}</span></v-ons-list-header>
        </v-ons-list>
        <v-ons-list>
            <v-ons-list-header>Kontoverlauf</v-ons-list-header>
