        ...
        <v-ons-list>
            <div class="gpsmenu1">
                <h6 style="color: #0076ff; padding-left: 0.4vh !important; padding-top: 0vh !important; display: inline-block; line-height: 3.5vh;" v-on:click="homescreen">
                    <ons-icon icon="md-arrow-back" style="font-size: 2vh; margin: 0; padding: 0; line-height: 0vh; color: red"></ons-icon>
                </h6>
            ...
            <div style="padding-top: 0.5vh; background-color: #efeff4" v-for="category in categories" :key="category.name">
                ...
                <div style="border-bottom: 0.13vh solid black;">
                    <div class="listhover" style="border-top: 0.07vh solid black;" v-for="gps in search(category.locations)" :key="gps.name" v-on:click="setgps(gps)">
