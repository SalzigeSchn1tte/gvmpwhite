<template>
  <v-ons-page>
    ...
    <v-ons-list>
      ...
      <v-ons-list-item modifier="longdivider">
        <v-ons-button style="width:100%; margin-right: 0.9375vh; margin-top: -1px;" class="color-background orange" modifier="large" v-on:click="addContact()">Kontakt hinzufügen</v-ons-button>
      </v-ons-list-item>
    </v-ons-list>
  </v-ons-page>
</template>
