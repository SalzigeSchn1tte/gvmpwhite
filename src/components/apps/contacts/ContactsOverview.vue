    ...
    <v-ons-page>
        ...
        <v-ons-list style="overflow:hidden;">
            ...
            <v-ons-list-item modifier="nodivider">
                <div class="center" style="text-align: center;">
                    <v-ons-fab modifier="mini" style="background-color: orange;  margin: 0 0.5vh; margin-left: 5.2vh;" position='center center'>
                        <v-ons-icon style="color:#ffffff; font-size: 2vh; line-height: 0vh;" icon="ion-android-call" v-on:click="callUser"></v-ons-icon>
                    </v-ons-fab>
                    <v-ons-fab modifier="mini" style="background-color: orange; line-height: 3.5vh; margin: 0 0.5vh;" position='center center'>
                    ...
                    <v-ons-fab v-if="contactName.indexOf('000FAV') >= 0" modifier="mini" style="background-color: orange; line-height: 3.5vh; margin: 0 0.5vh;" position='center center'>
                        <v-ons-icon style="color:#FFC541; font-size: 2.5vh; line-height: 0vh;" icon="ion-ios-star" v-on:click="setfav(contactName)"></v-ons-icon>
                    </v-ons-fab>
                    <v-ons-fab v-else modifier="mini" style="background-color: orange; line-height: 3.5vh; margin: 0 0.5vh;" position='center center'>
            ...
            <v-ons-list-item modifier="nodivider" style="display: block; height: 3.4vh;">
                <div class="center" style="color: orange" v-on:click="callUser">
                    Anrufen
                </div>
            </v-ons-list-item>
            <v-ons-list-item modifier="nodivider" style="display: block; height: 3.4vh;">
                <div class="center" style="color: orange" v-on:click="sendSMS(contactNumber,checkname(contactName))">
                    Nachricht senden
                </div>
            </v-ons-list-item>
            <v-ons-list-item modifier="nodivider" style="display: block; height: 3.4vh;">
                <div v-if="contactName.indexOf('000FAV') >= 0" class="center" style="color: orange" v-on:click="setfav(contactName)">
                    Von Favoriten enfernen
                </div>
                <div v-else class="center" style="color: orange" v-on:click="setfav(contactName)">
                    Zu Favoriten hinzufügen
                </div>
            </v-ons-list-item>
            <v-ons-list-item modifier="nodivider" style="display: block; height: 3.4vh;">
                <div class="center" style="color: orange" v-on:click="sendGPS()">
                    Standort teilen
                </div>
            </v-ons-list-item>
            <v-ons-list-item modifier="nodivider" style="display: block;">
                <div class="center" style="color: orange" v-on:click="sendContact(contactNumber)">
                    Kontakt teilen
                </div>
            </v-ons-list-item>
        </v-ons-list>
