<template>
    <v-ons-page>
        ...
        <ons-carousel fullscreen swipeable auto-scroll overscrollable id="carousel">
            <ons-carousel-item v-for="wallpaper in wallpapers" :key="wallpaper.id" v-bind:style="{ 'background-image': 'url(' + wallpaper.file + ')' }" style="background-position:center center;background-size:cover;">
