<template>
    <v-ons-page>
        ...
        <v-ons-list>
            ...
            <v-ons-list-item modifier="longdivider">
                <v-ons-button style="width:100%; margin-right: 10px; margin-top: -1px;" class="color-background orange" modifier="large" @click="sendRequest">Anfrage senden</v-ons-button>
            </v-ons-list-item>
        </v-ons-list>
    </v-ons-page>
</template>
